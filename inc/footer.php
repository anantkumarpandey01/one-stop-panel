            ...
            <div class="footer-content">
                ...
                <div class="ak-height-15 ak-height-lg-10"></div>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <a href="tel:<?php echo $phone; ?>" class="phone text-hover-animaiton white"><?php echo $phone; ?></a>
                    </div>
                </div>
                <div class="footer-menu-one" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500">
                    <div class="footer-menu">
                        <p class="menu-title">QUICK LINK</p>
                        <a href="index.php" class="menu-item text-hover-animaiton white">Home</a>
                        <a href="index.php#services" class="menu-item text-hover-animaiton white">Services</a>
                        <a href="book-assessment.php" class="menu-item text-hover-animaiton white">Book Online Assessment</a>
                        <a href="remote-assessment.php" class="menu-item text-hover-animaiton white">Remote Assessment Request</a>

...
<?php include 'inc/header.php'; ?>
                        ...
                        <div class="hero-slider-info">
                            <div class="slider-info">
                                <div class="hero-title">
                                     <h1 class="hero-main-title" data-swiper-parallax="300">Denting & Painting</h1>
                                    <h1 class="hero-main-title-1 style-2" data-swiper-parallax="100">Experts</h1>
                                    <p class="mini-title" data-swiper-parallax="400">Professional denting and painting services for your vehicle. Trust our skilled team since 2023.</p>
                                </div>
                                <div class="ak-height-45 ak-height-lg-30"></div>
                                <div data-swiper-parallax="300">
                                    <a href="book-assessment.php" class="common-btn">
                                        BOOK NOW HERE
                                    </a>
                                </div>
                            </div>
                ...
                <div class="ak-hero ak-style1 slide-inner">
                    ...
                    <div class="container">
                        <div class="hero-slider-info">
                            <div class="slider-info">
                                <div class="hero-title">
                                     <h1 class="hero-main-title" data-swiper-parallax="300">Auto Body Repair</h1>
                                    <h1 class="hero-main-title-1 style-2" data-swiper-parallax="100">Restoration</h1>
                                    <p class="mini-title" data-swiper-parallax="400">Expert auto body repair and painting since 2023. Your vehicle deserves the best.</p>
                                </div>
                                <div class="ak-height-45 ak-height-lg-30"></div>
                                <div data-swiper-parallax="300">
                                    <a href="book-assessment.php" class="common-btn">
                ...
                <div class="ak-hero ak-style1 slide-inner">
                    ...
                    <div class="container">
                        <div class="hero-slider-info">
                            ...
                            <p class="mini-title" data-swiper-parallax="400">Our skilled team of certified technicians is here to provide top-notch car repair and auto services to ensure your vehicle performs at its best. Our skilled team of certified technicians.</p>
                                </div>
                                <div class="ak-height-45 ak-height-lg-30"></div>
                                <div data-swiper-parallax="300">
                                    <a href="book-assessment.php" class="common-btn">
            ...
            <div class="hero-contact-info">
                <a href="tel:<?php echo $phone ; ?>">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <p class="ak-font-18 ak-white-color ak-semi-bold"><?php echo $phone; ?></p>
                    </div>
                </a>
                <a href="#">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <p class="ak-font-18 ak-white-color ak-semi-bold"><?php echo $address; ?></p>
                    </div>
                </a>
                <div class="d-flex align-items-center gap-2">
                    <div class="heartbeat-icon">
   ...
   <section class="container">
        <div class="row row-cols-1 row-cols-xl-3 g-4">
                ...
                <div class="service-item">
                    <div class="heartbeat-icon">
                        <a href="javascript:void();">
                            <span class="ak-heartbeat-btn"><img src="assets/img/speedome.svg" alt="one stop panel speedome"></span>
                        </a>
                    </div>
                    <div class="service-info">
                        <h4 class="title">DENTING CHECK</h4>
                        <p class="desp">Expert inspection for dents and damage, ensuring top-quality repair since <?php echo $year; ?>.</p>
                    </div>
                </div>
            </div>
            <div class="service-progress-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="service-item">
                    <div class="heartbeat-icon">
                        <a href="javascript:void();">
                            <span class="ak-heartbeat-btn"><img src="assets/img/car-repair.svg" alt="one stop panel car repair"></span>
                        </a>
                    </div>
                    <div class="service-info">
                        <h4 class="title">PAINTING REPAIR</h4>
                        <p class="desp">Professional painting services for flawless vehicle restoration since <?php echo $year; ?>.</p>
                    </div>
                </div>
            </div>
            <div class="service-progress-card" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="service-item">
                    <div class="heartbeat-icon">
                        <a href="javascript:void();">
                            <span class="ak-heartbeat-btn"><img src="assets/img/car.svg" alt="one stop panel car"></span>
                        </a>
                    </div>
                    <div class="service-info">
                        <h4 class="title">BODY RESTORATION</h4>
                        <p class="desp">Comprehensive auto body restoration services since <?php echo $year; ?> for all vehicles.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="choose-us-contain">
                <div class="choose-us-info" data-aos="fade-up">
                    <div class="ak-section-heading ak-style-1">
                        ...
                        <p class="ak-section-subtitle">Expert denting and painting services since 2023 in New Zealand. Trust our skilled team for quality auto body care.</p>
                    </div>
                    <div class="ak-height-60 ak-height-lg-30"></div>
                    <div class="stroke-heading-text">
                        <h3 class="ak-stroke-text hover-color-changes">Certified Denting Experts</h3>
                        <h3 class="ak-stroke-text hover-color-changes">Full Painting Services</h3>
                        <h3 class="ak-stroke-text hover-color-changes">900+ Satisfied Clients</h3>
                        <h3 class="ak-stroke-text hover-color-changes">Guaranteed Repairs</h3>
                    </div>
                    <div class="ak-height-60 ak-height-lg-30"></div>
                    <a href="tel:<?php echo $phone; ?>" class="common-btn">
                        Call Now
                    </a>
                </div>
               <div class="choose-us-img" data-aos="fade-up" data-aos-delay="150">
                    <img src="assets/img/choose-us.png" alt="one stop panel why choose us">
    ...
    <!-- Start Services -->
    <div id="services" class="ak-height-125 ak-height-lg-80"></div>
...
with insurance providers, corporate fleets, and individual vehicle owners, delivering clear
communication, swift turnaround times, and unwavering quality.
...
that endures.
    ...
    <div class="team-single-page-slider ak-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img class="slide-img" src="assets/img/1.jpeg" alt="..." />
            </div>
            <div class="swiper-slide">
                <img class="slide-img" src="assets/img/2.jpeg" alt="one stop panel image 2" />
            </div>
                ...
                <div class="h-100">
                    <div class="blog-card" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="blog-body-info">
                            ...
                            <a href="javascript:void()" class="blog-title">
                                ESTIMATION
            ...
            <div class="col">
                <div class="h-100">
                    <div class="blog-card" data-aos="fade-up" data-aos-delay="100">
						...
						<p class="custom-fs p-subtxt mb-3">With more than 3 years in the industry, we’re proud to be Wellington’s longest-standing and most trusted name in automotive repairs.

Our reputation comes from consistently delivering skilled workmanship, honest service, and genuine care for our customers.

For your confidence, every repair we carry out is backed by a lifetime warranty—covering you for as long as you own your vehicle.

It’s our promise that your car is repaired to the highest standards, ensuring it stays safe, dependable, and protected well into the future.</p>
							 <a href="tel:<?php echo $phone; ?>" class="more-btn1 mt-2 mb-2">
<img src="assets/img/phone.svg" alt="..."> Call now to book with the centre nearest you and one of our staff will manage your repair through our facilities.</a>
                        </div>
                        <div class="blog-footer-info pb-2">
    ...
    <div class="container-fluid">
        <div class="cta" data-aos="fade-right">
            ...
            <div class="cta-info">
                <h2 class="cta-title" data-aos="fade-left" data-aos-delay="100">Contact Our Experts Today</h2>
                <p class="cta-desp fs-5">Call your nearest Automotive Repair Centre now to arrange an estimate</p>
                <a href="tel:<?php echo $phone; ?>" class="cta-btn">
                   <img src="assets/img/phone.svg" alt="...">
                    <span class="ms-2">FIND US</span>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center gap-lg-0 gap-3" id="counter">
            <div class="col-lg-4">
                <div class="ak-funfact ak-style1" data-aos="fade-up">
                    <div class="ak-funfact-number">
                        <div>
                            <span id="count1" class="ak-stroke-number counter" data-number="3"></span>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="ak-funfact ak-style1" data-aos="fade-up" data-aos-delay="100">
                    <div class="ak-funfact-number">
                        <div>
                            <span id="count2" class="ak-stroke-number counter" data-number="150"></span>
                        </div>
                        <div><span class="ak-stroke-number">+</span></div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="ak-funfact ak-style1" data-aos="fade-up" data-aos-delay="150">
                    <div class="ak-funfact-number">
                        <div>
                            <span id="count3" class="ak-stroke-number counter" data-number="150"></span>
                        </div>
                        <div><span class="ak-stroke-number">+</span></div>
                    </div>
                    <div class="ak-funfact-text">
                        ...
                        <div class="testimonal-info ak-style1">
                            <div class="slider-info">
                                <div class="d-flex justify-content-between align-items-end">
                                    <div>
                                        <h5 class="name">Liam O'Connor</h5>
                                ...
                                <h4 class="desp">“Exceptional service at One Stop Panel and Paint! Fixed my car dents perfectly since 2023.”</h4>
                            </div>
